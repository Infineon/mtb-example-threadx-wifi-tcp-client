...
#define SOFTAP_PASSWORD "SOFTAP_PASSWORD"
 ...
 *
 *******************************************************************************/
void tcp_client_task(cy_thread_arg_t arg)
{
    cy_rslt_t result;
...
static cy_rslt_t softap_start(void)
{
    ...
    cy_wcm_ap_config_t softap_config = {softap_credentials, SOFTAP_BAND_SELECT, SOFTAP_RADIO_CHANNEL,
                                        softap_ip_info,
                                        NULL};
